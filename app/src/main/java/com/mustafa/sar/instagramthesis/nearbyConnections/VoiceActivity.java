package com.mustafa.sar.instagramthesis.nearbyConnections;
 ...
 */
public class VoiceActivity extends ConnectionsActivity implements SensorEventListener {
    /** If true, debug logs are shown on the device. */
    private static final boolean DEBUG = true;

    Context mContext = VoiceActivity.this;
    ...
    private static final String SERVICE_ID =
            "com.mustafa.sar.instagramthesis.nearbyMessaging.SERVICE_ID";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voice_nearby);

        try {
            getSupportActionBar()
                    .setBackgroundDrawable(ContextCompat.getDrawable(mContext, R.drawable.ActionBar));
    ...
    private void updateTextView(TextView textView, State state) {
        switch (state) {
            ...
            case ADVERTISING:
                ...
                textView.setText(this.getString(R.string.status_advertising));
                break;
            case CONNECTED:

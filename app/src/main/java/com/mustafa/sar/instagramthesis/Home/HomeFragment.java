...
import com.mustafa.sar.instagramthesis.utilities.HomeFeedListAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private void displayPhotos(){
        if(mPhotos != null){
            ...
            mAdapter = new HomeFeedListAdapter(getActivity(), R.layout.layout_home_feed_list_item, mPhotos);

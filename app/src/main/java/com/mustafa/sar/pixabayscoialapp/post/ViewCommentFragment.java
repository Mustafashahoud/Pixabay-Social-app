package com.mustafa.sar.pixabayscoialapp.post;
...
import com.mustafa.sar.pixabayscoialapp.utilities.CommentRecyclerViewAdapter;
...
public class ViewCommentFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.comment_recyclerView);
        ...
        mCheckMark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!mComment.getText().toString().equals("")){
                    Log.d(TAG, "onClick: add new comment.");
                    addNewComment(mComment.getText().toString());

                    mComment.setText("");
                    closeKeyboard();
                }else{
                    Toast.makeText(mContext, "Please insert a comment", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setupWidgets(){
        ...
        CommentRecyclerViewAdapter adapter = new CommentRecyclerViewAdapter(mContext,
                R.layout.layout_single_comment, mComments);
...
/**************Firebase ***********************/
    private void setupFirebaseAuth(){
        ...
        try{
            ...
            Log.d(TAG, "setupFirebaseAuth: NullPointerException " +e.getMessage());
        }
